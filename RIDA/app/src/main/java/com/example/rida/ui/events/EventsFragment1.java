...
public class EventsFragment1 extends Fragment {
    Toolbar toolbar;
    TextView introtxt;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        //Sample data
        final List<Boolean> data = Arrays.asList(false, false, false, false, false, true);
        ...
        adapter = new WeekViewAdapter(data) {
            ...
            @Override
            public View getDayLayout(final View dv, final int index){
...
//                        if ((Boolean) get(index - 2) == true){
//                            data.set(index - 2, false);
//                            getStrokeColor(index -2);
//                            getFillColor(index -2);
//                        } else {
//                            data.set(index - 2, true);
//                            getStrokeColor(index -2);
//                            getFillColor(index -2);
//                        }
                    }
